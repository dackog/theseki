    ...
    <div style={{ background: 'var(--paper-warm)', minHeight: '100dvh' }}>
      <div className="policy-page">
        <div className="policy-content">
          ...
          <h1>プライバシーポリシー</h1>
          <p className="policy-meta">制定日：2026年4月16日</p>

          <p>
            DaC Kogure（以下「運営者」といいます）は、席割・イベント管理サービス「The SEKI」（以下「本サービス」といいます）における利用者の個人情報の取り扱いについて、以下のとおりプライバシーポリシーを定めます。
          </p>
